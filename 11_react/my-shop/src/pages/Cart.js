...
import { decreaseCount, increaseCount, removeItemFromCart, slectCartList } from '../features/cart/cartSlice';
        ...
        <tbody>
          ...
          {cartList.map((cart, index) => {
            ...
            <tr key={cart.id}>
              ...
              <td>
                <button type="button" // 장바구니 지우기
                onClick={() => {dispatch(removeItemFromCart(cart.id))}}>❌</button> 
              </td>
            </tr>)
          })}
        </tbody>
