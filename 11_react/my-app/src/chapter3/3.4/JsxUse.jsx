...
function JsxUse(props) {
  // JSX의 사용법(문법)
  // http://localhost:3000/ 에들어가서 확인가능
  // 1. 꼭 닫혀야 하는 태그
  // const element = (
  //   <div>
  //     {/* HTML 에서는 input 또는 br 태그를 사용할 때 닫지않고 사용가능 하지만 리액트에서는 태그를 열었으면 무조건 닫아야 함 */}
  //     <div></div>
  //       <input/>
  //       <br/>
  //   </div>
...
export default JsxUse; //Jsx 컴포넌트 내보내기 
// exprot를 해줘야 다른곳에서 import 가능